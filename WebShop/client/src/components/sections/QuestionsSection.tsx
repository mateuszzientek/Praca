  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center  md:mr-[40rem]  md:ml-[20rem] lg:ml-[13rem] xl:ml-[8rem] pt-20 font-roboto font-bold">
        <p className="text-5xl md:text-5xl pc:text-7xl text-black/70 dark:text-white">
          {t("questionSection.main")}
        </p>
        <p className=" text-black/50 mt-10 dark:text-white/70 text-lg md:text-xl lg:text-2xl pc:text-3xl w-[25rem] sm:w-[30rem] md:w-[23rem] lg:w-[32rem] pc:w-[40rem] mx-auto">
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex justify-center space-x-10 mt-10 items-center ">
            ...
            <input
              ...
              className="px-3 w-[10rem] sm:w-[13rem] md:w-[10rem] lg:w-[13rem] h-[3rem] rounded-full shadow-button focus:outline-none focus:border-2 border-black/60"
              type="text"
          ...
          <div className="flex flex-col items-center">
            <input
              ...
              className="px-3 w-[20rem] md:w-[17rem] lg:w-[20rem] h-[3rem] rounded-full shadow-button focus:outline-none mt-10 focus:border-2 border-black/60"
              type="email"
            ...
            <textarea
              ...
              className="p-2 mt-10 shadow-button rounded-2xl focus:outline-none focus:border-2 border-black/60 w-[25rem] md:w-[18rem] lg:w-[25rem] h-[7rem]"
            ...
            {message && (
              <p className="text-red-500 text-base mt-4">{message}</p>
            )}
