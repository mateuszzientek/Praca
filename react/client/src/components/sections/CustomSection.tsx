...
function CustomSection() {
  ...
  return (
    <div className="customSection-background">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 10 1440 180">
        <path
      ...
      <div className="flex justify-center mt-20">
        <h2 className=" text-white font-roboto-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl pc:text-7xl">
          {t("customSection.main")}
        </h2>
      </div>
      ...
      <div className="flex justify-center lg:space-x-8 pb-28 lg:pb-44  ">
        <div className="hidden lg:block mt-20 shadow-white up-down-aniamation ">
          <LazyLoadImage
            ...
            className="rounded-3xl lg:h-[31rem] pc:h-[37rem] "
          />
        </div>
        ...
        <div>
          ...
          <div>
            <div className=" text-white font-roboto-bold text-base md:text-xl pc:text-2xl w-[24rem] md:w-[28rem] pc:w-[27rem] mt-8 text-center lg:text-left">
              <p className="mb-4 pc:mb-9 text-2xl md:text-3xl shadow-text lg:text-left  ">
                {t("customSection.text1")}
              </p>
          ...
          <div className="flex justify-center lg:justify-start">
            <button
              ...
              className="text-xl pc:text-2xl rounded-3xl bg-white text-center mt-8 pc:mt-12 w-auto py-3 px-4 transform hover:scale-110 transition ease-out duration-300"
            >
