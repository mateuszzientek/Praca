  ...
  const handleSubmit = async () => {
    ...
    if (isValid) {
      ...
      const data = {
        ...
        price: 115 + selectedDelivery.price,
        email,
        name,
        surname,
        street,
      ...
      try {
        ...
        const newStorageRef = ref(
          storage,
          `/orderCustomProjects/${userId}/${orderNumber}`
        );
  ...
  return (
    <>
      ...
      <div className="fixed w-screen h-screen z-50 bg-white dark:bg-[#292929] overflow-y-auto overflow-x-hidden">
        ...
        >
          <div className="flex items-center justify-center  lg:space-x-[10rem] xl:space-x-[25rem] 2xl:space-x-[40rem] pc:space-x-[45rem] w-[90rem]  h-full">
            ...
            {delivery.map((type, index) => (
              ...
              >
                <div className="flex flex-col">
                  <div className="flex items-center cursor-pointer ">
                    <input
                      ...
                      checked={
                        selectedDelivery && selectedDelivery.name === type.name
                      }
                    />
                    <div className="w-5 h-5 border-2 border-black/80 dark:border-white/80 rounded-full transition-all peer-checked:bg-black/80 dark:peer-checked:bg-white"></div>
                ...
                <div className="flex space-x-1 items-center">
                  ...
                  <LazyLoadImage
                    src={require("../../assets/images/" + type.image + ".jpg")}
                    alt="Logo firmy"
                    className="w-8"
                    effect="blur"
          ...
          <div className="w-screen lg:w-[35rem] 2xl:w-[40rem] xl:pl-12 px-10 md:px-16 xl:px-0 mt-8 lg:mt-0">
            ...
            >
              <div className="flex items-center justify-center">
                ...
                <p className="text-xl text-black/80">{t("checkout.text20")}</p>
              </div>
            </button>
          </div>
        </div>
