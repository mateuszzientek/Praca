    ...
    return (
        <div className={`flex justify-center text-center h-[75rem] md:h-[50rem]   ${theme === 'dark' ? "questions-background-black questions-background-mobile-black" : "questions-background questions-background-mobile"}`}>
            ...
            <div className="flex flex-col items-center  md:mr-[40rem]  md:ml-[20rem] lg:ml-[13rem] xl:ml-[8rem] pt-20 font-roboto font-bold text-black/70 dark:text-white">
                <p className="text-5xl md:text-5xl xl:text-7xl ">{t('questionSection.main')}</p>
                <p className="mt-10 text-lg md:text-xl lg:text-2xl xl:text-3xl w-[25rem] sm:w-[30rem] md:w-[23rem] lg:w-[32rem] xl:w-[40rem] mx-auto">{t('questionSection.text')}</p>

                <div className="flex justify-center space-x-10 mt-10 items-center ">

                    {/* name and surname buttons */}

                    <input className='px-3 w-[10rem] sm:w-[13rem] md:w-[10rem] lg:w-[13rem] h-[3rem] rounded-full shadow-button focus:outline-none focus:border-2 border-black/60' type="text" placeholder={t('questionSection.name')} />

                    <input className='px-3 w-[10rem] sm:w-[13rem] md:w-[10rem] lg:w-[13rem] h-[3rem] rounded-full shadow-button focus:outline-none focus:border-2 border-black/60' type="text" placeholder={t('questionSection.surname')} />
